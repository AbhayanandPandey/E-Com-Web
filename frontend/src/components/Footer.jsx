...
const Footer = () => {
    return (
        <footer className='bg-gray-50 border-t border-gray-200 pt-16 pb-8 px-6 md:px-20 relative mt-8'>
            ...
            <div className='flex flex-col sm:grid sm:grid-cols-[3fr_1fr_1fr] gap-14 text-sm'>
                ...
                <div>
                    <Link to='/'>
                        <img src={logo} className=' cursor-pointer mb-5 w-36' alt="Shopwave logo" /></Link>
                ...
                <div>
                    ...
                    <ul className='flex flex-col gap-2 text-gray-600'>
                        <li className='cursor-pointer hover:text-indigo-600 hover:translate-x-1 transition-transform duration-200'>Home</li>
                        <li className='cursor-pointer hover:text-indigo-600 hover:translate-x-1 transition-transform duration-200'>About Us</li>
                        <li className='cursor-pointer hover:text-indigo-600 hover:translate-x-1 transition-transform duration-200'>Delivery</li>
                        <li className='cursor-pointer hover:text-indigo-600 hover:translate-x-1 transition-transform duration-200'>Privacy Policy</li>
                    </ul>
                </div>
